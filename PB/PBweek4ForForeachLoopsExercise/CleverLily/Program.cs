...
namespace CleverLily
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double money = 0;
            //създаваме цикъл за всеки рожден ден
            for (int i = 1; i <= age; i++)
            {
                if (i % 2 == 0)
                {
                    //За втория рожден ден получава 10.00 лв, като сумата се увеличава с 10.00 лв.,
                    //за всеки следващ четен рожден ден(2-> 10, 4-> 20, 6-> 30...и т.н.).
                    //Tова е равно на годините *5 - 1 лев който брат и е взимал// 2 по 5 =10, 4по 5 =20, 6 по 5 = 30... 
                    money += i * 5 - 1;
            ...
            //Проверяваме дали спестванията са достатъчни
            if (money >= washingMprice)
            {
                Console.WriteLine($"Yes! {money - washingMprice:f2}");
            }
            else 
            {
                Console.WriteLine($"No! {Math.Abs(money - washingMprice):f2}");
            }
