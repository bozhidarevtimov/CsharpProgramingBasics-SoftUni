...
namespace Moving
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // големина в кубични метри
            int space = widht * lenght * height;
            ...
            while (boxes != "Done")
            {
                boxesMoved += int.Parse(boxes);
                if (boxesMoved > space)
                {
                    Console.WriteLine($"No more free space! You need {boxesMoved - space} Cubic meters more.");
                    break;
                }
            ...
            if(boxes == "Done")
            {
                Console.WriteLine($"{space - boxesMoved} Cubic meters left.");
            }
