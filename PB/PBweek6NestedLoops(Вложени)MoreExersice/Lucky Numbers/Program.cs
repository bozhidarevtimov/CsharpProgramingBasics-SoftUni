...
namespace Lucky_Numbers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //променливи
            //променлива където да записваме щасливо число
            string luckkyNumber = "";


            //2. генерира всички възможни
            //"щастливи" и различни 4 - цифрени числа(всяка цифра от числото е в интервала[1...9]).
            //правим 1 цикъл с 3 вложени с начало 1 и край 9 за да получим всички 4 цифрени комбинации с числата от 1 до 9
                ...
                for (int second = 1; second <=9 ; second++)
                {
                    for (int third = 1; third <=9 ; third++)
                    {
                        for (int forth = 1; forth <=9 ; forth++)
                        {
                            //Щастливо число е 4 - цифрено число, на което сбора от първите две цифри е равен на сбора от последните две.
                            //Числото N трябва да се дели без остатък от сбора на първите две цифри на "щастливото" число.
                            if ((first + second == third+forth) && N%(first + second) == 0)
                            {
